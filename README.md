...
### Running witneysbot Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start witneysbot locally by running:
...
Then you can interact with witneysbot by typing `witneysbot help`.

    witneysbot> witneysbot help
    witneysbot animate me <query> - The same thing as `image me`, except adds [snip]
    witneysbot help - Displays all of the help commands that witneysbot knows about.
    ...
